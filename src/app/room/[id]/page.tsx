      ...
      <div className="space-y-4">
        ...
        <header className="flex items-center justify-between py-2 border-b border-slate-200/80">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-2xl text-xs font-extrabold bg-indigo-50 text-indigo-700 border border-indigo-100 hover:bg-indigo-100 transition-all flex items-center gap-1.5 cursor-pointer shadow-sm"
          >
        ...
        <section className="sys-card p-5 space-y-1.5 border-slate-200/80 shadow-sm bg-white rounded-3xl">
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-1.5">
              ...
              {isHost && (
                <span className="text-[10px] font-bold text-amber-700 bg-amber-50 border border-amber-200 px-2 rounded-full flex items-center gap-0.5">
        ...
        {isVoted && !showVoteForm ? (
          <div className="sys-card p-5 border-emerald-200 bg-emerald-50/60 space-y-3 shadow-sm rounded-3xl">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-2xl bg-emerald-500 text-white flex items-center justify-center font-bold shrink-0 shadow-sm">
            ...
            <div className="flex items-center gap-2 pt-2 border-t border-emerald-100 flex-wrap">
              <button
                type="button"
                onClick={() => setShowShareSheet(true)}
                className="flex-1 py-2.5 rounded-2xl bg-indigo-600 text-white font-black text-xs flex items-center justify-center gap-1.5 shadow-md shadow-indigo-500/20 cursor-pointer hover:bg-indigo-700 transition-all"
              >
        ...
        <div className="sys-card p-2 bg-white/95 backdrop-blur-md border border-slate-200/80 shadow-xl rounded-2xl">
          {!isVoted || showVoteForm ? (
            ...
            <button
              type="button"
              onClick={() => setShowShareSheet(true)}
              className="w-full h-11 rounded-xl bg-indigo-600 text-white font-black text-xs flex items-center justify-center gap-1.5 shadow-md shadow-indigo-600/20 cursor-pointer hover:bg-indigo-700 transition-all"
            >
